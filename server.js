...
        
        res.status(500).json({
S           error: 'Lỗi server khi xử lý dữ liệu',
            details: err.message,
            prediction_status: duDoanTrangThai,
            prediction_time: duDoanThoiGian
        });
...
    } catch (err) {
    _   console.error('❌ Lỗi khi lấy dữ liệu /data:', err.message);
...
  S   console.log(`🔔 Hệ thống sẽ gửi cảnh báo KHI AI THAY ĐỔI TRẠNG THÁI`);
}); tôi tìm thấy một đống lỗi trong code của bạn đấy 
lấy lại code của tôi đi